...
public class SelectAppGet {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// when we use the get method hibernate will directly goes to the database and tries to get the record no 
			// intermediate object (proxy object) will be created this we call it as a egar loading
